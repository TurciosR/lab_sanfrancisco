...
$fechahoy=date("Y-m-d");
$fechaanterior=restar_dias($fechahoy, 361);
    ...
    <div class="col-lg-12">
      <div class="ibox float-e-margins">
        <?php 	if($links!='NOT' || $admin=='1' ){
          ...
          if ($admin=='1' )
          echo "<a href='agregar_credito.php' class='btn btn-primary' role='button'><i class='fa fa-plus icon-large'></i> Agregar Cuenta</a>";
          echo "</div>";
          //permiso del script
          ?>
