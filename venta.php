...
function info_cobro($id_cobro){
  ...
  $nombre_paciente = ($row3['nombre']);
  $apellido_paciente = ($row3['apellido']);
  ...
  $paciente = eliminar_acentos($paciente);
  $paciente = preg_replace('/\xc2\xa0/', '', $paciente);
...
function quitar_tildes1($cadena)
{
    $no_permitidas= array ("á","é","í","ó","ú","Á","É","Í","Ó","Ú","ñ","Ñ","Ã","Ì","Ò","Ù","Ã™","Ã ","Ã¨","Ã¬","Ã²","Ã¹","ç","Ç","Ã¢","ê","Ã®","Ã´","Ã»","Ã‚","ÃŠ","ÃŽ","Ã”","Ã›","ü","Ã¶","Ã–","Ã¯","Ã¤","«","Ò","Ã","Ã„","Ã‹"," ");
