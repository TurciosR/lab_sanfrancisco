			...
			<div class="col-lg-12">
					<div class="form-group">
						<label class="control-label">Contraseña actual</label>
							<input type="password" name="oldpass" id="oldpass" class="form-control col-lg-10">
					...
					<div class="form-group">
						<label class="control-label">Contraseña nueva</label>
							<input type="password" name="newpass" id="newpass" class="form-control col-lg-10">
					</div>
