...
function senddata()
{
	...
	if(process=='insert')
	{
		...
		var dataString='process='+process+'&nombre='+nombre+'&usuario='+usuario+'&clave='+clave+'&admin='+admin+'&activo='+activo+'&empleado='+empleado;
	}
	if(process=='edited')
	{
		var id_usuario=$('#id_usuario').val();
		var urlprocess='editar_usuario.php';
		var dataString='process='+process+'&nombre='+nombre+'&usuario='+usuario+'&clave='+clave+'&admin='+admin+'&id_usuario='+id_usuario+'&activo='+activo+'&empleado='+empleado;
	}
...
function deleted()
{
	...
	var dataString = 'process=deleted' + '&id_usuario=' + id_usuario+ '&id_sucursal=' + id_sucursal;
	$.ajax({
		type : "POST",
