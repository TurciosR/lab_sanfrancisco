...
function initial()
	{
	$_PAGE = array ();
	$title = 'Registro Diario de Clientes';
	$_PAGE ['title'] = $title;
	$_PAGE ['links'] = null;
									 ...
									 <div class="row">
										 <div class="col-md-6">
											 <div class="form-group has-info single-line">
												 ...
												 <input type="text" class="form-control datepicker" id="fecha1" name="fecha1" value="<?php echo $fecha1; ?>">
											 </div>
										 </div>
										 <div class="col-md-6">
											 <div class="form-group has-info single-line">
...
<?php
	include("footer.php");
	echo "<script src='js/funciones/funciones_reporte_corte_laboratorio.js'></script>";
		} //permiso del script
else {
