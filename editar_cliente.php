				...
				<div class="ibox">
					...
					if ($links!='NOT' || $admin=='1' ){
						...
						<div class="ibox-title">
							<h5 class="text-navy"><i class="fa fa-pencil-square-o"></i> <?php echo $title; ?></h5>
						</div>
							...
							<form name="formulario" id="formulario">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group has-info ">
											...
											<input type="text" placeholder="Nombre del cliente" class="form-control may" id="nombre" name="nombre" value="<?php echo $nombre; ?>">
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group has-info ">
								...
								<div class="row">
									...
									<div class="col-md-3">
										<div class="form-group has-info ">
											<label>Giro  </label>
											<input type="text" placeholder="Giro del cliente" class="form-control may" id="giro" name="giro" value="<?php echo $giro; ?>">
										</div>
									</div>
									<div class="col-md-3">
										<div class="form-group has-info ">
											<label>Teléfono 1 </span></label>
	                    ...
	                    <div class="form-group has-info ">
	                      ...
	                      <input type="text" placeholder="10%" class="form-control decimal" id="porcentaje_descuento" name="porcentaje_descuento" value="<?php echo $porcentaje_descuento;?>">
	                    </div>
	                  </div>
										<div class="col-md-2">
										<div class="form-group has-info ">
											<br>
											<div class='radio i-checks'><label><input id='retiene' name='retiene' type='checkbox' <?php if($retiene){ echo " checked "; }?>> <span class="label-text"><b> Remision</b></span></label></div>
											<input type="hidden" name="hi_retiene" id="hi_retiene" value="<?php echo $retiene;?>">
										</div>
									</div>
