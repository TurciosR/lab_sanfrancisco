...
function initial() {
  ...
  $boton="";
	...
	$uri ="agregar_examen_paciente.php";
  $filename="agregar_examen_paciente.php";
  $links=permission_usr($id_user,$filename);
  date_default_timezone_set('America/El_Salvador');
  $fecha_hoy=date("Y-m-d");
  $sql_uss = _query("SELECT id_empleado FROM usuario WHERE id_usuario='$id_user'");
  $datss =_fetch_array($sql_uss);
  $id_emps = $datss["id_empleado"];
  ...
  $id_examen_paciente = $dato_pac["id_examen_paciente"];
                          ...
                          <form name="formulario" id="formulario">
                            ...
                            <div class="row">
                              <div class="form-actions col-lg-12">
                                <input type="hidden" name="process" id="process" value="<?php echo $boton; ?>">
                                ...
                                <input type="submit" id="sig" name="sig" value="<?php echo $boton; ?>" class="btn btn-primary m-t-n-xs pull-right"/>
          ...
          if($insertar)
          {
            ...
            if($numrows1 == 1)
            {
                ...
                if($insertar1)
                {
                   ...
                   $xdatos['hey']=$proceso;
                   $xdatos['paciente']=$id_paciente;
                   $xdatos['cobro']=$id_cobro;
                }else
                {
