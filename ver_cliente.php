...
$sql="SELECT p.*, d.nombre_departamento, m.nombre_municipio  FROM cliente as p, departamento as d, municipio as m WHERE id_cliente='$id_cliente' AND p.depto = d.id_departamento AND p.municipio = m.id_municipio ";
$result = _query($sql);
