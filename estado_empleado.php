...
<div class="modal-header">
	...
	<h4 class="modal-title"> <?php echo $estadoS;?> Empleado</h4>
</div>
...
function estado()
{
  ...
  $estado = $_POST ['estado'];
	...
	{
		$sql="SELECT * FROM examen_paciente WHERE id_empleado='$id_empleado' and id_sucursal='$id_sucursal'";
		$result=_query($sql);
		$count=_num_rows($result);
		if($count>0){
			$xdatos['typeinfo']='Error';
			$xdatos['msg']='Empleado no puede ser desactivado!';
