                      ...
                      <div class="ibox-title">
                        ...
                        <div class="ibox-content">
                            <form name="formulario" id="formulario">
                              <?php
                              $sql2 = "SELECT * FROM condicion_pago where estado='1' and id_sucursal='$id_sucursal'";
                              $res=_query($sql2);
                              $act = _num_rows($res);
                                	if ($act>=2){
                                    $col=3;
                                    ...
                                    <div class="form-group col-lg-<?php echo "$col";  ?>">
                                        ...
                                        <div class="form-group col-lg-3">
                                            ...
                                            <select class="col-md-12 select" id="tipo_doc" name="tipo_doc" >
                                              <option value="">Seleccione</option>
                                              <?php
                                                  $sqld = "SELECT * FROM condicion_pago where and id_sucursal='$id_sucursal'";
                                                  $resul=_query($sqld);
                                                  while($depto = _fetch_array($resul))
                                                  {
                                      ...
                                      <?php }else {
                                        echo "<input type='hidden' id='tipo_doc' name='tipo_doc' value='fac'>";
                                      } ?>
                                        <div class="form-group col-lg-<?php echo "$col";  ?>">
                                ...
                                <div class="row">
                                  <div class="form-group col-lg-4">
                                      ...
                                      <select class="col-md-12 select " id="examen" name="examen">
                                          <option value="">Seleccione</option>
                                          <?php
                                              $sqld = "SELECT * FROM examen where id_sucursal='$id_sucursal'";
                                              $resul=_query($sqld);
...
function insertar(){
    ...
    $id_sucursal=$_SESSION["id_sucursal"];
    $sll = _query("SELECT * FROM cobro WHERE numero_doc='$n_doc' and id_sucursal='$id_sucursal'");
    if(_num_rows($sll)>0)
    {
