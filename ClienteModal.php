			...
			<div class="col-lg-12">
				<form name="formulario" id="formulario" autocomplete="off">
						...
						<div class="row">
								...
								<div class="form-group col-lg-6">
										<label>Fecha de Nacimiento</label>
											...
											<input type="text" placeholder="Ingrese fecha nacimiento" class="datepicker form-control" id="naci" name="fecha_nacimiento"   >
					...
					<div>
						...
						<input type="submit" id="btnAddClient" name="submit1" value="Guardar" class="btn btn-primary m-t-n-xs" />
