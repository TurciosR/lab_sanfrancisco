...
function initial()
	{
	$_PAGE = array ();
	$title = 'Reporte de Descargos Realizados';
	$_PAGE ['title'] = $title;
	$_PAGE ['links'] = null;
...
<?php
	include("footer.php");
	echo "<script src='js/funciones/funciones_reporte_descargo.js'></script>";
		} //permiso del script
else {
...
function traer(){
	...
	Where mp.id_movimiento>0  AND mp.id_sucursal='1' AND mp.tipo='SALIDA' AND mp.fecha between '$desde' and '$hasta'");
	$num=1;
