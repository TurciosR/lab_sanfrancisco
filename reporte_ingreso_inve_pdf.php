...
$sql3="SELECT mp.*,mpd.*,concat(em.nombre,' ', em.apellido)as nombre, pr.descripcion  FROM movimiento_producto as mp
  ...
  WHERE mp.tipo='ENTRADA'AND mp.id_sucursal='$id_sucursal' and mp.total>0 AND mp.fecha between '$desde' and '$hasta'";
...
$pdf->SetXY($set_x, $set_y);
$pdf->Cell(215,5,utf8_decode("CARGA DE INVENTARIO REALIZADOS"),0,1,'C');
$pdf->SetFont('courier','',10);
$pdf->SetXY($set_x, $set_y+5);
