<?php
	...
	// Page setup
	$_PAGE = array ();
	$title = 'Administrar Cargos de inventario';
	$_PAGE ['title'] = $title;
	$_PAGE ['links'] = null;
	...
	$id_sucursal=$_SESSION["id_sucursal"];
	 ...
	 WHERE em.id_empleado=mp.id_empleado and mp.id_movimiento>0 and mp.tipo='ENTRADA' and
	mp.id_sucursal='$id_sucursal' and mp.total>0 ORDER by mp.id_movimiento DESC";
	$result=_query($sql);
		...
		<div class="col-lg-12">
			<div class="ibox float-e-margins">
				...
				if ($links!='NOT' || $admin=='1' ){
					...
					$filename='ingreso_inventario.php';
					$link=permission_usr($id_user,$filename);
					if ($link!='NOT' || $admin=='1' )
					echo "<a href='ingreso_inventario.php' class='btn btn-primary' role='button'><i class='fa fa-plus icon-large'></i> Agregar Inventario</a>";
						...
						for($i=0;$i<$count;$i++){
							...
							echo"<td><div class=\"btn-group\">
								...
								<ul class=\"dropdown-menu dropdown-primary\">";
									...
									$link=permission_usr($id_user,$filename);
									if ($link!='NOT' || $admin=='1' )
										echo "<li><a data-toggle='modal' href='ver_detalle_movimiento_ingreso.php?id_detalle=".$row['id_movimiento']."' data-target='#verModal' data-refresh='true'><i class=\"fa fa-book\"></i> Ver Detalle</a></li>";
							echo "	</ul>
										</div>
										</td>
										</tr>";
