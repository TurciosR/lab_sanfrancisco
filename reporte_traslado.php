...
$sql_suc=_fetch_array(_query("SELECT CONCAT('Sucursal ',sucursal.nombre_lab,' ',sucursal.direccion) as destino,traslado.id_sucursal_origen,traslado.fecha  FROM traslado JOIN sucursal ON traslado.id_sucursal_destino=sucursal.id_sucursal WHERE traslado.id_traslado=$id_traslado"));
