										...
										<form name="formulario" id="formulario">
											<div class="row">
												<div class="col-md-6">
													<div class="form-group has-info single-line">
														...
														<input type="text" placeholder="Nombre del Proveedor" class="form-control may" id="nombre_proveedor" name="nombre_proveedor" value="<?php echo $nombre; ?>">
													</div>
												</div>
											<div class="col-md-6">
												<div class="form-group has-info single-line">
													<label>Nombre Legal  <span style="color:red;">*</span></label>
													<input type="text" placeholder="Nombre comercial" class="form-control may" id="nombre_legal" name="nombre_legal" value="<?php echo $nombre_legal; ?>">
												</div>
											</div>
										</div>
											<div class="row">
												<div class="col-md-3">
													<div class="form-group has-info single-line">
														...
														<input type="text" placeholder="Dirección" class="form-control may" id="direccion" name="direccion" value="<?php echo $direccion; ?>">
													</div>
												</div>
											...
											<div class="row">
												...
												<div class="col-md-3">
													<div class="form-group has-info single-line">
														...
														<input type="text" placeholder="Giro del negocio" class="form-control may" id="giro" name="giro" value="<?php echo $giro; ?>">
													</div>
												</div>
											</div>
											...
											<div class="row">
												<div class="col-md-3">
													<div class="form-group has-info single-line">
														...
														<input type="text" placeholder="Nombre del Contacto" class="form-control may" id="nombre_contacto" name="nombre_contacto" value="<?php echo $nombre_contacto; ?>">
													</div>
												</div>
												<div class="col-md-3">
													<div class="form-group has-info single-line">
														<label>Nombre para Cheques <span style="color:red;">*</span></label>
														<input type="text" placeholder="Nombre para cheques" class="form-control may" id="nombre_cheque" name="nombre_cheque" value="<?php echo $nombre_cheque; ?>">
													</div>
												</div>
											...
											<div class="row">
												...
												<div class="col-md-3">
													<div class="form-group has-info single-line">
														<label>Correo</label>
														<input type="text" placeholder="mail@server.com" class="form-control may" id="correo" name="correo" value="<?php echo $email; ?>">
													</div>
												</div>
												<div class="col-md-3">
													<div class="form-group has-info single-line">
											...
											<div class="row">
												...
												<div class="col-md-2">
													<div class="form-group has-info single-line">
														<div class='radio i-checks'><label><input id='percibe' name='percibe' type='checkbox' <?php if($percibe){ echo " checked "; }?>> <span class="label-text"><b>Percibe 1%</b></span></label></div>
...
function insertar()
{
	...
	$nombre_legal=strtoupper($_POST["nombre_legal"]);
