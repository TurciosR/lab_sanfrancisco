...
function initial()
{
                      ...
                      <div class="widget-header">
                        <div class="row">
                          <div class="col-md-4">&nbsp;&nbsp;
                            ...
                            <h3 class="text-navy" id='title-table'><i class="fa fa-th-list"></i> <?php echo $title; ?></h3>
                          </div>
  ...
  function traerdatos()
  {
    ...
    $sqlJoined="  SELECT pr.id_producto,pr.descripcion, pr.barcode, c.nombre_cat as cat, SUM(su.stock) as cantidad
    FROM producto AS pr, categoria_p AS c, stock AS su ";

    $sqlParcial= get_sql($start,$limit,$keywords,$sortBy, $barcode);
    ...
    function traerpaginador()
    {
      ...
      if(isset($_POST['page']))
      {
        include('Pagination.php');
        $sqlParcial=get_sql($start,$limit,$keywords,$sortBy,$barcode);
        $sql1="SELECT COUNT(DISTINCT(pr.id_producto)) as numRecords  FROM producto AS pr, categoria_p AS c, stock as su ";
    ...
    function get_sql($start,$limit,$keywords,$sortBy,$barcode)
    {
      $andSQL='';
      $id_sucursal= $_SESSION['id_sucursal'];
