...
WHERE ep.id_examen>0 AND ep.estado_realizado='Hecho' AND ep.estado_impresion='Hecho' and ep.id_sucursal='$id_sucursal' AND ep.examen_paciente_nulo= 0 AND ep.fecha_examen BETWEEN '$antes' AND '$hoy'";
