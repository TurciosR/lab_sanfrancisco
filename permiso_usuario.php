        ...
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <h3 class="text-navy"><i class="fa fa-lock"></i> <b><?php echo $title;?></b></h3>
                </div>
                <div class="ibox-content">
					...
					";
	                $sql_menus="SELECT menu.* FROM menu, modulo WHERE modulo.id_menu=menu.id_menu GROUP BY modulo.id_menu ORDER BY count(modulo.id_modulo) ASC";
	                      //order by prioridad
									...
									$sql_link_user="SELECT menu.id_menu, menu.nombre as nombremenu, menu.prioridad, modulo.id_modulo,
									 modulo.nombre as nombremodulo, modulo.descripcion, modulo.filename, usuario_modulo.id_usuario
									  ...
									  AND usuario_modulo.id_modulo=modulo.id_modulo
										and usuario.id_sucursal='$id_sucursal'
										and usuario_modulo.id_sucursal='$id_sucursal'
									  AND menu.id_menu=modulo.id_menu
...
function permissions()
{
    ...
    for ($i=0;$i<$cuantos ;$i++)
    {
		...
		$sql1="SELECT * FROM usuario_modulo WHERE id_usuario='$id_usuario' AND id_modulo='$id_modulo' and id_sucursal='$id_sucursal'";
		$result1=_query($sql1);
