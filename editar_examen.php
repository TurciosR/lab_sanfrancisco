                            ...
                            <table class="table table-bordered table-hover" id="tabla">
                              <thead>
                                <tr>
                                  ...
                                  <th  class="col-lg-2" style="display:none;">VALORES DE REFERENCIA oculto</th>
                              ...
                              <tbody id="tsb">
                                ...
                                if($ncampos<=1){
                                  ...
                                  <tr  style='height:35px;'>
                                    ...
                                    <td  class='vr' style="display:none;"></td>
                                ...
                                {
                                  $verificar_tamanio=explode("|",$campos[$i]);
                                  $tamanio=count($verificar_tamanio);
                                  if($tamanio==5){
                                    list($parametro, $unidad_medida, $valor_referencia,$verificar_fila,$predefinido) = explode("|",$campos[$i]);
                                    if($verificar_fila=="s"){
                                      ?>
                                      <tr style='height:35px;' class='s info'>
                                        <td class='tex seccion' colspan='4'><?php echo $parametro;?></td>
                                        <td class='text-center'><a class=' lndelete' type='button' name='button'> <span class='fa fa-trash'></span> </a></td>
                                      </tr>
                                    ...
                                    ?>
                                    <tr style='height:35px;' class='p'>
                                      <td class='tex param'><?php echo $parametro;?></td>
                                      <td class='tex unidad'><?php echo $unidad_medida;?></td>
                                      <td class='tex predefinido'><?php echo $predefinido;?></td>
                                      <td class='vr' style="display:none;">
                                  ...
                                  if($tamanio<=4){
                                    list($parametro, $unidad_medida, $valor_referencia,$verificar_fila) = explode("|",$campos[$i]);
                                    if($verificar_fila=="s"){
                                      ?>
                                      <tr style='height:35px;' class='s info'>
                                        <td class='tex seccion' colspan='4'><?php echo $parametro;?></td>
...
function editar_examen()
{
  ...
  $id_sucursal=$_SESSION["id_sucursal"];
  $sql_result=_query("SELECT id_examen FROM examen WHERE nombre_examen='$nombre_examen' AND id_examen!='$id_examen' AND id_categoria='$id_categoria' and id_sucursal='$id_sucursal'");
